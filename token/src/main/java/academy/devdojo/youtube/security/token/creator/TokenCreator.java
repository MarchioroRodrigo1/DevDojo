...
public class TokenCreator {
    ...
    public SignedJWT createSignedJWT(Authentication auth){
        ...
        KeyPair rsaKeys = generaterKeyPair();
    ...
    @SneakyThrows
    private KeyPair generaterKeyPair(){
        log.info("Generater RSA 2048 bits Keys");
    ...
    public String encryptToken (SignedJWT signedJWT) throws JOSEException, KeyLengthException {
        ...
        log.info("Encrypting token with system private key");
