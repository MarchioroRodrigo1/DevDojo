...
public class TokenConverter {
    ...
    public String decryptToken(String encryptedToken){
        ...
        log.info("Token decrypted, returning sined token . . .");
        return  jweObject.getPayload().toSignedJWT().serialize();
    }

    @SneakyThrows
    public void  validateTokenSinature(String signedToken){
        log.info("Starting method to validator token signature ...");
